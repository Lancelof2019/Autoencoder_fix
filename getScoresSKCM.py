...
class AutoEncoder(tf.keras.Model):
    ...
    def train(self):
       ...
       # costfinal, res = self.sess.run([self.loss_, self.H], feed_dict=feed_dictio)
        ...
        plt.savefig(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\figure\loss_curve\cmt_picture' + str(iterator + 1) + '_test17.png')
        plt.close()
...
if __name__ == '__main__':
    ...
    selected_features = np.genfromtxt(
        r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\data\selected_features.csv',
        delimiter=',',
        skip_header=1)
    # log10(htseq_fpkm + 1)
    inputhtseq = np.genfromtxt(
        r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\data\exp_intgr.csv',
    ...
    inputmethy = np.genfromtxt(
        r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\data\mty_intgr.csv',
        dtype=np.unicode_, delimiter=',', skip_header=1)
    ...
    namehtseq = np.genfromtxt(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\data\exp_feature_names.csv', dtype=np.unicode_, delimiter=',', skip_header=1)
    namemethy = np.genfromtxt(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\data\mty_feature_names.csv', dtype=np.unicode_, delimiter=',', skip_header=1)

    # tanh activation function
    act = tf.nn.tanh

    #fname = './result/32run/comm_trials_binary.pkl'
    #fname = (r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\comm_trials_binary_test.pkl')
    fname = (r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\comm_trials_binary_test17.pkl')
        ...
        if htseq_nbr > 1 and methy_nbr > 1:
           ...
           # loss, h, shapfeat = sae.Main(best)
            ...
            if loss < best_loss:
                ...
                #with open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\shap_doc\\' + cmtname + 'shapfeat_htseq.csv', 'w') as csvfile:
                   # writer = csv.writer(csvfile)
                   # [writer.writerow(r) for r in np.vstack((namehtseq_sel.reshape(1, len(namehtseq_sel)),
                                                          # shapfeat[0][0]))]

                #with open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\shap_doc\\' + cmtname + 'shapfeat_methy.csv', 'w') as csvfile:
                   # writer = csv.writer(csvfile)
                ...
                #fname = r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\shap_doc\cmt_SHAPValues.pkl'
                #pickle.dump(shapfeat, open(fname, "wb"))
                with open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\community\communityScores_compare17.csv', 'w') as csvfile:
                    writer = csv.writer(csvfile)
                    [writer.writerow(r) for r in cmt_scores]
                #with open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\shap_doc\\' + cmtname + 'reshtseq.csv', 'w') as csvfile:
                   # writer = csv.writer(csvfile)
                    #[writer.writerow(r) for r in reshtseq]
                #with open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\shap_doc\\' + cmtname + 'resmethy.csv', 'w') as csvfile:
                    #writer = csv.writer(csvfile)
