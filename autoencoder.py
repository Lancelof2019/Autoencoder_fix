...
# 构造带有时间戳的文件名
log_filename = f'myapp.{current_time}_test8.log'
    ...
    def train(self, train_index, val_index):
        ...
        while epoch < self.max_epochs and stop == False:
            ...
            for sample in mini_batches:
                ...
                cost_val = tf.reduce_mean(self.lossfun(batch_xs1, batch_xs2))
                logging.info(self.trainable_variables)
...
if __name__ == '__main__':
    ...
    f = open(
        r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\comm_parameter_binary17.txt',
        'w+')
    f.close()
    ...
    for iterator in range(3):
        ...
        if htseq_nbr > 1 and methy_nbr > 1:
            ...
            # save the best HPs
            # fname = (r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\comm_trials_binary_test06.pkl')
            ...
            # print("-------------Time count--------------------")
            # f1 = open(r'C:\Users\gklizh\Documents\Workspace\code_and_data04\data\python_related\result\comm_parameter_binary_backup.txt',
            #     'a+')
            # print("---------open the file to load the best items in best-----------------------------")
